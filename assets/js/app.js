  ...
  var zomatoSearch = function (restaurantSearch) {
    ...
    $.ajax({
      ...
      .then(function (response) {
        ...
        $(".rname").text(response.restaurants[0].restaurant.name)
        $(".cuisine").text(response.restaurants[0].restaurant.cuisines)
        $(".location").text(response.restaurants[0].restaurant.location.locality_verbose)
      })
  }
